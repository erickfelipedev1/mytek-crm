...
FIELDS=(
  ...
  # O default sai do repositório DESTA instalação (repo_da_imagem, em
  # _common.sh) — num fork, o upstream fixo aqui instalava o app de outro
  # projeto contra o banco deste, e em `--yes` isso passava sem ninguém ver.
  "APP_IMAGE|Imagem Docker do app|$(repo_da_imagem):latest|||"
